...
![smartass](https://img.shields.io/badge/smartass-42-green)
...
No matter the algorithm we chose, we need an **evaluation function** that calculates the board's positions and returns a score. We will use this score to let the AI know which positions are good or bad.
...
Get the whole function: [Evaluation function](https://github.com/Danielratmiroff/chess-ai/blob/master/src/lib/components/evaluateBoard.ts)
...
**Good to know:**
There is a thing called [The horizon effect](https://www.chessprogramming.org/Horizon_Effect), which is caused by limited depth of the search algorithm. You can further reduce it by adding _quiescence search_ to the algorithm.
...
I encorage you to try it out and play a game here: [Play a game](https://chess-ai-danielratmiroff.vercel.app/)

Hope you have a fun time!

## UI Design:

![Screenshot](https://raw.githubusercontent.com/Danielratmiroff/myblog/master/images/chessai/ai-screenshot.jpg)\
